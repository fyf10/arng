(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Auto Update Trackers': 'Auto Update Trackers',
            'Tracker Auto Update Interval': 'Tracker Auto Update Interval',
            'Daily': 'Daily',
            'Weekly': 'Weekly',
            'Monthly': 'Monthly',
            'Tracker Sources': 'Tracker Sources',
            'Add Tracker Source': 'Add Tracker Source',
            'Remove Tracker Source': 'Remove Tracker Source',
            'Update Trackers Now': 'Update Trackers Now',
            'Tracker Source URL': 'Tracker Source URL',
            'Last Update Time': 'Last Update Time',
            'Never': 'Never',
            'Updating trackers...': 'Updating trackers...',
            'Trackers updated successfully': 'Trackers updated successfully',
            'Failed to update trackers': 'Failed to update trackers',
            'Please add at least one tracker source': 'Please add at least one tracker source',
            'Invalid tracker source URL': 'Invalid tracker source URL',
            'Tracker source already exists': 'Tracker source already exists',
